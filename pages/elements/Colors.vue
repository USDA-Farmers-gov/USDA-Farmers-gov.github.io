<template>
  <div>
    ...
    <ColorSwatches :data="data.primaryColors()" />
    ...
    <ColorSwatches :data="data.secondaryColors()" />
    ...
    <ColorSwatches :data="data.lowSaturationColors()" />
    ...
    <ColorSwatches :data="data.greyscaleColors()" rowClasses="text-margin-bottom" />
    ...
    <ColorSwatches :data="data.specialStates()" />
  </div>
</template>
